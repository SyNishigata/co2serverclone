...
<div class="form-group">
    ...
    <div class="tabs-content home-tabs" data-tabs-content="travel-tabs">
        <div class="tabs-panel is-active" id="carpanel">
			...
			<!-- Begin Sy's Edits: Fixed grammatical errors -->
            <div class="input-group">
			...
			<!-- Begin Sy's Edits: Commented out old format and added my own where picking a model precedes the question:
			     'What is your car's fuel efficiency'.  Also added a question incase user can't find their car. -->
            <div class="input-group">
				...
				Sy's Edits: Ending of old format-->
				
				<!-- Sy's Edits:  Begin new format -->
				<span class="input-group-addon"> Specify the type of car you have. </span>
                <div class="row">
                    <div class="small-4 large-4 columns">
                        <select id="car_make" name="car_make" onchange="get_car_models()">
                            <option>Select a Make</option>
				...
				<div class="row">
                    <div class="small-6 columns">
						<span class="input-group-addon"> Can't find your car?  Manually enter your efficiency here: </span>
					</div>
					<div class="small-6 columns">
						<input type="text" name="car_efficiency" onchange="carbon_car()" id="car_efficiency"
							class="form-control" value="<?php echo !empty($carbon_data) ? $travel['car_efficiency'] : '' ?>">
				...
				<!-- Sy's Edits: Ending of new format -->
            </div>
			<!-- End Sy's Edits -->
            <!-- .Car Form -->
        </div>
        <div class="tabs-panel" id="bikepanel">
			...
			<!-- Begin Sy's Edits: Added extra divs (rows and columns) so I could place the questions and inputs on the same line -->
			<div class="row">
				<div class="small-6 columns">
					<div class="input-group">
						<span class="input-group-addon"> What is your total year&#39;s motorcycle mileage? </span>
						<input type="text" name="mcycl_miles" onchange="carbon_mcycl()" id="mcycl_miles" class="form-control" value="<?php echo !empty($carbon_data) ? $travel['mcycl_miles']:''?>">
					</div>
				</div>
				<div class="small-6 columns">
					<div class="input-group">
						<span class="input-group-addon"> What is the CC of your motorcycle? </span>
						<select name="mcycl_cc" onchange="carbon_mcycl()" id="mcycl_cc" class="form-control" value="<?php echo !empty($carbon_data) ? $travel['mcycl_cc']:''?>">
            ...
            <div class="input-group" id="mcycl_helper" style="display:none">
                <div class="row">
                    <div class="small-6 columns">
                        ...
                        <input type="text" min="0" name="mcycl_last" onchange="carbon_mcycl()" id="mcycl_last" value="<?php echo !empty($carbon_data) ? $travel['mcycl_last']:''?>" >
                    </div>
                    <div class="small-6 columns">
                        <span class="input-group-addon"> Enter the date of last check</span>
                        <input type="text" name="mcycl_last_date" onchange="carbon_mcycl()" id="mcycl_last_date" value="<?php echo !empty($carbon_data) ? $travel['mcycl_last_date']:''?>" class="datepick">
                    </div>
                </div>
                <div class="row">
                    <div class="small-6 columns">
                        <span class="input-group-addon"> Current motorcycle mileage </span>
                        <input type="text" min="0" name="mcycl_current" onchange="carbon_mcycl()" id="mcycl_current" value="<?php echo !empty($carbon_data) ? $travel['mcycl_current']:''?>">
                    </div>
                    <div class="small-6 columns">
                        <span class="input-group-addon"> Enter the date of current safety/oil check</span>
                        <input type="text" name="mcycl_current_date" onchange="carbon_mcycl()" id="mcycl_current_date" value="<?php echo !empty($carbon_data) ? $travel['mcycl_current_date']:''?>" class="datepick">
                    </div>
                </div>
            </div>
        ...
        <div class="tabs-panel" id="buspanel">
                ...
                <div class="medium-6 large-6 columns">
                    ...
                    <div class="input-group row">
                        ...
                        <div class="small-4 columns"><select name="btrip_freq" id="btrip_freq" value="">
                            <option value="week">week</option><option value="month">month></option><option value="year">year></option></select></div>
                    </div>
                    <div class="input-group row">
                    ...
                    <div class="input-group row">
                        ...
                        <input type="hidden" name="bcount" id="bcount" value="<?php echo !empty($carbon_data) ? sizeof($travel['busfrom']):'0'?>">
                    </div>
            ...
            <div class="row">
                <input type="hidden" name="total_bus_trip" id="total_bus_trip" vale="<?php echo !empty($carbon_data) ? $travel['total_bus_trip']:'0'?>">
            ...
            <div class="row">
                <div class="medium-6 large-6 columns">
                    ...
                    <div class="input-group row">
                        ...
                        <input type="hidden" name="total_train_trip" id="total_train_trip" value="<?php echo !empty($carbon_data) ? $travel['total_train_trip']:'0'?>">
                        <input type="hidden" name="rcount" id="rcount" value="<?php echo !empty($carbon_data) ? sizeof($travel['trainfrom']):'0'?>">
                ...
                <div class="routes" id="train_routes">
                    <?php if (!empty($travel['trainfrom'])){ 
                        ...
                        for($i = 0; $i < $max;$i++) { ?>
                            ...
                            <?php echo $travel['traintrips'][$i];?> times per <?php echo $travel['trainfreq'][$i];?> 
            ...
            <div class="row">
                <div class="medium-6 large-6 columns">
                    ...
                    <div class="input-group row">
                        ...
                        <input type="hidden" name="pcount" id="pcount" value="<?php echo !empty($carbon_data) ? sizeof($travel['planefrom']):'0'?>"> 
                        <input type="hidden" name="total_plane_trip" id="total_plane_trip" value="<?php echo !empty($carbon_data) ? $travel['total_plane_trip']:'0'?>">      
                    </div>
                    ...
                    <?php if (!empty($travel['planefrom'])){ 
                        ...
                        for($i = 0; $i < $max;$i++) { ?>
                            ...
                            <span onclick="remove_plane_route(<?php echo $travel['planemiles'][$i] . ',' . $i; ?>)">[Remove]</span>
                                ...
                                <input type="hidden" name="planetrips[]" value="<?php echo $travel['planetrips'][$i];?>">
                                <input type="hidden" name="planert[]" value="<?php echo $travel['planert'][$i];?>">
                                <input type="hidden" name="planemiles[]" value="<?php echo $travel['planemiles'][$i];?>">
                            </div>
                    <?php } } ?>
                </div>
            </div>
